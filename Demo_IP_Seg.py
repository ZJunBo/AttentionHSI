...
from Model.model_IP import AttentionHSI
...
for (FLAG,curr_train_ratio) in [(1, 0.1)]:
    ...
    model = AttentionHSI(num_classes=17, n_bands=200, dim=96)
    ...
    for eep in range(max_epoch):
        ...
        if eep%10==0:
            ...
            print("eep", eep, " test", rightNum, testNum, "OA", OA*100, "AA",AA*100, "kappa", kappa*100)
            if eep == 90:
